...
class ScheduledJobsHubScreenNew extends StatefulWidget {
  const ScheduledJobsHubScreenNew({Key? key}) : super(key: key);

  @override
  State<ScheduledJobsHubScreenNew> createState() => _ScheduledJobsHubScreenNewState();
}
...
class _ScheduledJobsHubScreenNewState extends State<ScheduledJobsHubScreenNew> {
                                ...
                                children: [
                                  Expanded(
                                    child: _buildFilterChip(
                                      context,
                                      label: 'Day',
                                      isSelected: jobProvider.currentFilter == JobFilter.day,
                                      onTap: () => jobProvider.setFilter(JobFilter.day),
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: _buildFilterChip(
                                      context,
                                      label: 'Week',
                                      isSelected: jobProvider.currentFilter == JobFilter.week,
                                      onTap: () => jobProvider.setFilter(JobFilter.week),
                                    ),
                                  ),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: _buildFilterChip(
                                      context,
                                      label: 'Month',
                                      isSelected: jobProvider.currentFilter == JobFilter.month,
                                      onTap: () => jobProvider.setFilter(JobFilter.month),
                                    ),
                                  ),
                                ],
                              ),
                          ...
                          child: jobProvider.scheduledJobs.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final job = jobProvider.scheduledJobs[index];
  ...
  void _handleReschedule(BuildContext context, JobProvider jobProvider, Job job) {
    showDialog(
      context: context,
